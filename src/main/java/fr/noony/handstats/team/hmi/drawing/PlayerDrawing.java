...
public class PlayerDrawing implements PropertyChangeListener {
    ...
    private void processMouseClick(MouseEvent event) {
        MainLogger.log(Level.INFO, "MouseClicked on player", event, this);
        switch (selectedState) {
            case IDLE:
            case SELECTED:
    ...
    private void processMouseEntered(MouseEvent event) {
        MainLogger.log(Level.OFF, "Mouse Entered on player", event, this);
        switch (selectedState) {
            case IDLE:
            case SELECTED:
    ...
    private void processMouseExited(MouseEvent event) {
        MainLogger.log(Level.OFF, "Mouse Exited on player ", event, this);
        switch (selectedState) {
            case IDLE:
            case SELECTED:
                background.setStroke(idleStrokeColor);
