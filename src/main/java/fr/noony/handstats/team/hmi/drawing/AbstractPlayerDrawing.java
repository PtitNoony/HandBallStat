 ...
 */
public class AbstractPlayerDrawing implements PropertyChangeListener {
    ...
    private final Image playerIcon = new Image(AbstractPlayerDrawing.class.getResourceAsStream("alien.png"));
    private final Image playerIconInversed = new Image(AbstractPlayerDrawing.class.getResourceAsStream("alienInversed.png"));
    private final Image playerIconRed = new Image(AbstractPlayerDrawing.class.getResourceAsStream("alienRed.png"));
    private final Image timeIcon = new Image(AbstractPlayerDrawing.class.getResourceAsStream("time.png"));
    private final Image timeIconInversed = new Image(AbstractPlayerDrawing.class.getResourceAsStream("timeInversed.png"));
    private final Image timeIconRed = new Image(AbstractPlayerDrawing.class.getResourceAsStream("timeRed.png"));
    ...
    public AbstractPlayerDrawing(Player player, String eventName) {
        propertyChangeSupport = new PropertyChangeSupport(AbstractPlayerDrawing.this);
        lookupContents.add(propertyChangeSupport);
        eventNameOnAction = eventName;
        player.getLookup().lookup(PropertyChangeSupport.class).addPropertyChangeListener(AbstractPlayerDrawing.this);
        //
        myPlayer = player;
    ...
    public AbstractPlayerDrawing(Player player) {
