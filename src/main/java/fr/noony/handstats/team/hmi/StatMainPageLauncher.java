 ...
 */
public class StatMainPageLauncher extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        //MatchScoreBoard
        loader = new FXMLLoader(getClass().getResource("StatMainPage.fxml"));
        try {
            loader.load();
        ...
        primaryStage.show();
        //
        //XMLLoader.getMenTeam(), 
        controller.loadParameters(XMLLoader.getWomenTeam());
    }
